              ...
              <div>
                <div className='pb-6'>
                  ...
                  <p className='text-sm text-slate-500'>
                    Orang lain akan melihatmu sesuai dengan data yang Anda
                    isikan di bawah.
                  </p>
                </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className='flex flex-col'>
                            ...
                            <FormDescription>
                              Alamat ini tidak wajib diisi, hanya jika Anda
                              ingin menambahkan lokasi alternatif
                            </FormDescription>
                            <FormControl>
                              <Input
                                disabled={disable}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className='flex flex-col'>
                            ...
                            <FormDescription>
                              Masukkan tanggal lahir Anda. Kolom ini opsional
                              dan bisa dibiarkan kosong.
                            </FormDescription>
                            <Popover modal={true}>
